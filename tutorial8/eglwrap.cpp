...
extern "C" void glOrthox (int left, int right, int bottom, int top, int zNear, int zFar)
{
    FlushOnStateChange();
  return glEsImpl->glOrthox(left, right, bottom, top, zNear, zFar);  
}

extern "C" void glColor4x (int red, int green, int blue, int alpha)
{
    FlushOnStateChange();
  return glEsImpl->glColor4x(red, green, blue, alpha);  
}

extern "C" void glClearColorx (int red, int green, int blue, int alpha)
{
    FlushOnStateChange();
  return glEsImpl->glClearColorx(red, green, blue, alpha);  
}

extern "C" void glTranslatex (int x, int y, int z)
{
    FlushOnStateChange();
  return glEsImpl->glTranslatex(x, y, z);  
}

extern "C" void glRotatex (int angle, int x, int y, int z)
{
    FlushOnStateChange();
  return glEsImpl->glRotatex(angle, x, y, z);  
}

extern "C" void glTexParameterx (int target, int pname, int param)
{
    FlushOnStateChange();
  return glEsImpl->glTexParameterx(target, pname, param);  
}

extern "C" void glScalex (int x, int y, int z)
{
    FlushOnStateChange();
  return glEsImpl->glScalex(x, y, z);  
}

extern "C" void glDrawArrays (int mode, int first, int count)
{
    FlushOnStateChange();
  return glEsImpl->glDrawArrays(mode, first, count);  
}
